...
assert.equal(state.providerCellCounts.seaFloor, 49);
assert.equal(state.providerCellCounts.seaFloorMaterial, 49);
...
runtime.dispose();
console.log("core-world-runtime: 49 active cells and nine separated provider layers passed");
