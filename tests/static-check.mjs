...
const worldSource = sourceFiles
  ...
  .map(file => fs.readFileSync(file, "utf8"))
  .join("\n");
for (const token of ["createCoreWorldDomain", "createUniformGridPartition", "createFlatWorldSurface", "createTerrainProviderAdapter", "defineWorldEffectProvider"]) {
...
assert.match(html, /LuminaryLabs-Dev\/NexusEngine@38229f59c22cb40024ffd13a9f48040de759f5d7\/src\/index\.js/);
assert.match(html, /src\/main-cloudform\.js\?v=core-world-1/);
